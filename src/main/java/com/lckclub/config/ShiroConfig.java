...
import com.lckclub.config.realm.MyCredentialsMatcher;
import com.lckclub.config.realm.MyShiroFilter;
import com.lckclub.config.realm.MyShiroRealm;
...
public class ShiroConfig {
  ...
  public CookieRememberMeManager rememberMeManager() {
    ...
    cookieRememberMeManager.setCipherKey(Base64.encode("lckclub is the best!".getBytes()));
